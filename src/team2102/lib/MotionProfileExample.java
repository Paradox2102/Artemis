...
public class MotionProfileExample {
	 ...
	 * keep one copy.
	 */
	private final CANTalon.MotionProfileStatus _status = new CANTalon.MotionProfileStatus();
	...
	private final List<double[]> m_points;
	 ...
	 * @param points
	 */
	public MotionProfileExample(CANTalon talon, List<double[]> points) {
		_talon = talon;
		m_points = points;
		/*
	...
	private void startFilling() {
		...
		final CANTalon.TrajectoryPoint point = new CANTalon.TrajectoryPoint();
		...
		for (int i = 0; i < m_points.size(); ++i) {
			...
			point.position = m_points.get(i)[0];
			point.velocity = m_points.get(i)[1];
			point.timeDurMs = 5; // TODO: Not hardcoded
