 ...
 *
 */
public class SelectBoilerAutoCommand extends LoggingCommandBase {

	private Command m_cmd;

	public SelectBoilerAutoCommand() {
	...
	protected void initialize() {
		...
		case Red:
			m_cmd = new BoilerAutoRedCommand();
			break;

		case Blue:
			m_cmd = new BoilerAutoBlueCommand();
			break;
