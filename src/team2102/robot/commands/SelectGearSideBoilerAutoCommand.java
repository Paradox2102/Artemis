 ...
 *
 */
public class SelectGearSideBoilerAutoCommand extends LoggingCommandBase {

	private Command m_cmd;

	public SelectGearSideBoilerAutoCommand() {
	...
	protected void initialize() {
		...
		m_cmd = new GearSideBoilerAutoCommand(alliance);
		m_cmd.start();
	}
