 ...
 *
 */
public class SideGearPlacerFeederBlueCommand extends CommandGroup {

	public SideGearPlacerFeederBlueCommand() {
		...
		addSequential(new GearPlacerCommand(RobotMap.k_driveToGearSpeed, true));		// addSequential(new DriveToGearCommand(48, -1000, true));
